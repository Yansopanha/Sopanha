    ...
    1766: function(e, t, n) {
        ...
        (r = function() {
            ...
            _setupCodecs: function() {
                ...
                return e._codecs = {
                    ...
                    weba: !!(!d && t.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
                    webm: !!(!d && t.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
        ...
        (a = function(e) {
            ...
            load: function() {
                ...
                for (var o = 0; o < this._src.length; o++) {
                    if (this._format && this._format[o])
                        e = this._format[o];
                    else {
            ...
            play: function(e, t) {
                ...
                if (n._webAudio) {
                    ...
                    h.load());
                    var A = window && window.ejecta || !h.readyState && i._navigator.isCocoonJS;
                    if (h.readyState >= 3 || A)
                        v();
                    else {
                        n._playLock = !0,
                        ...
                        var y = function() {
                            n._state = "loaded",
                            v(),
                            h.removeEventListener(i._canPlayEvent, y, !1)
                        };
                        h.addEventListener(i._canPlayEvent, y, !1),
                        n._clearTimer(s._id)
                    }
                }
                return s._id
            ...
            volume: function() {
                ...
                if (0 === r.length)
                    return o._volume;
                if (1 === r.length || 2 === r.length && void 0 === r[1] ? o._getSoundIds().indexOf(r[0]) >= 0 ? t = parseInt(r[0], 10) : e = parseFloat(r[0]) : r.length >= 2 && (e = parseFloat(r[0]),
                t = parseInt(r[1], 10)),
                void 0 === e || !(e >= 0) || !(e <= 1))
                ...
                for (var a = 0; a < t.length; a++)
                    (n = o._soundById(t[a])) && (n._volume = e,
                    r[2] || o._stopFade(t[a]),
                    o._webAudio && n._node && !n._muted ? n._node.gain.setValueAtTime(e, i.ctx.currentTime) : n._node && !n._muted && (n._node.volume = e * i.volume()),
            ...
            _stopFade: function(e) {
                ...
                return t && t._interval && (this._webAudio && t._node.gain.cancelScheduledValues(i.ctx.currentTime),
            ...
            loop: function() {
                ...
                for (var r = this._getSoundIds(t), i = 0; i < r.length; i++)
                    ...
                    this.playing(r[i]) && (this.pause(r[i], !0),
                    this.play(r[i], !0)))));
                return this
            },
            rate: function() {
                var e, t, n, o = this, r = arguments;
                if (0 === r.length ? t = o._sounds[0]._id : 1 === r.length ? o._getSoundIds().indexOf(r[0]) >= 0 ? t = parseInt(r[0], 10) : e = parseFloat(r[0]) : 2 === r.length && (e = parseFloat(r[0]),
                t = parseInt(r[1], 10)),
                "number" != typeof e)
                ...
                for (var a = 0; a < t.length; a++)
                    if (n = o._soundById(t[a])) {
                        o.playing(t[a]) && (n._rateSeek = o.seek(t[a]),
                        n._playStart = o._webAudio ? i.ctx.currentTime : n._playStart),
                        n._rate = e,
                        o._webAudio && n._node && n._node.bufferSource ? n._node.bufferSource.playbackRate.setValueAtTime(e, i.ctx.currentTime) : n._node && (n._node.playbackRate = e);
                        var s = o.seek(t[a])
                          , u = 1e3 * ((o._sprite[n._sprite][0] + o._sprite[n._sprite][1]) / 1e3 - s) / Math.abs(n._rate);
                        (o._endTimers[t[a]] || !n._paused) && (o._clearTimer(t[a]),
            ...
            seek: function() {
                ...
                if (0 === o.length ? n._sounds.length && (t = n._sounds[0]._id) : 1 === o.length ? n._getSoundIds().indexOf(o[0]) >= 0 ? t = parseInt(o[0], 10) : n._sounds.length && (t = n._sounds[0]._id,
                ...
                if (r) {
                    if ("number" == typeof e && e >= 0) {
                        ...
                        var d = n.playing(t) ? i.ctx.currentTime - r._playStart : 0
        ...
        (s = function(e) {
            ...
            create: function() {
                ...
                return e._webAudio ? (this._node = void 0 === i.ctx.createGain ? i.ctx.createGainNode() : i.ctx.createGain(),
                this._node.gain.setValueAtTime(t, i.ctx.currentTime),
                this._node.paused = !0,
                this._node.connect(i.masterGain)) : i.noAudio || (this._node = i._obtainHtml5Audio(),
                this._errorFn = this._errorListener.bind(this),
                this._node.addEventListener("error", this._errorFn, !1),
                this._loadFn = this._loadListener.bind(this),
                this._node.addEventListener(i._canPlayEvent, this._loadFn, !1),
        ...
        n.g.Howler = i,
        n.g.Howl = a,
        n.g.Sound = s) : "undefined" != typeof window && (window.HowlerGlobal = r,
        window.Howler = i,
        window.Howl = a,
        window.Sound = s),
        ...
        ,
        Howl.prototype.init = (f = Howl.prototype.init,
        function(e) {
        ...
        Howl.prototype.stereo = function(e, t) {
            ...
            for (var r = n._getSoundIds(t), i = 0; i < r.length; i++) {
                ...
                if (a) {
                    ...
                    "spatial" === o ? void 0 !== a._panner.positionX ? (a._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime),
                    a._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime),
                    a._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : a._panner.setPosition(e, 0, 0) : a._panner.pan.setValueAtTime(e, Howler.ctx.currentTime)),
            ...
            for (var i = r._getSoundIds(o), a = 0; a < i.length; a++) {
                ...
                if (s) {
                    if ("number" != typeof e)
                        return s._pos;
                    s._pos = [e, t, n],
                    s._node && ((!s._panner || s._panner.pan) && v(s, "spatial"),
                    ...
                    s._panner.positionZ.setValueAtTime(n, Howler.ctx.currentTime)) : s._panner.setPosition(e, t, n)),
                    r._emit("pos", s._id)
                }
            }
            return r
        ...
        Howl.prototype.orientation = function(e, t, n, o) {
            ...
            for (var i = r._getSoundIds(o), a = 0; a < i.length; a++) {
                ...
                if (s) {
                    ...
                    s._panner.orientationZ.setValueAtTime(n, Howler.ctx.currentTime)) : s._panner.setOrientation(e, t, n)),
        ...
        Howl.prototype.pannerAttr = function() {
            ...
            if (1 === o.length) {
                if ("object" != typeof o[0])
                    return (n = this._soundById(parseInt(o[0], 10))) ? n._pannerAttr : this._pannerAttr;
                e = o[0],
            ...
            for (var r = this._getSoundIds(t), i = 0; i < r.length; i++)
                if (n = this._soundById(r[i])) {
                    ...
                    var s = n._panner;
                    s || (n._pos || (n._pos = this._pos || [0, 0, -.5]),
                    v(n, "spatial"),
                    s = n._panner),
        ...
        ,
        Sound.prototype.init = (h = Sound.prototype.init,
        function() {
            var e = this._parent;
        ...
        Sound.prototype.reset = (m = Sound.prototype.reset,
        function() {
            var e = this._parent;
